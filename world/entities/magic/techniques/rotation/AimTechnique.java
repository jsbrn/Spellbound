...
public class AimTechnique extends Technique {
    ...
    public void update(MagicSource source) {
        double[] mwc = Camera.getWorldCoordinates(Game.getGameState(Game.GAME_SCREEN).getInput().getMouseX(),
                Game.getGameState(Game.GAME_SCREEN).getInput().getMouseY(), Window.getScale());
