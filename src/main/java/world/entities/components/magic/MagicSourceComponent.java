...
public class MagicSourceComponent extends Component {
    ...
    private MagicSourceComponent next;

    private List<Integer> lastColliding;
    private boolean lastLocationSolid;

    public MagicSourceComponent(double x, double y, Integer caster, ArrayList<Technique> techniques, Color color) {
...
//                ((EffectTechnique) t).affectContinuous(this);
    ...
    public List<MagicSourceComponent> getCollidingMagic() {
        List<MagicSourceComponent> inner = body.getLocation().getRegion().getMagicSources(
                body.getLocation().getCoordinates()[0],
                body.getLocation().getCoordinates()[1],
                body.getReachRadius()
